...
projects[acquia_connector][download][tag] = 8.x-1.6
...
projects[conflict][download][url] = https://git.drupal.org/project/conflict
projects[conflict][download][tag] = 8.x-1.0-alpha1
...
projects[features][download][tag] = 8.x-3.0
...
projects[media_entity_twitter][download][tag] = 8.x-1.3
...
projects[multiversion][download][tag] = 8.x-1.0-alpha12
...
projects[replication][download][tag] = 8.x-1.0-alpha5
...
projects[views_infinite_scroll][download][tag] = 8.x-1.3
...
projects[workspace][download][tag] = 8.x-1.0-alpha4